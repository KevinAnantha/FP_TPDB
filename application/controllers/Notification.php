...
class Notification extends CI_Controller {
	...
	public function index()
	{
		...
		$data_order = $this->M_edit->select_order($order_id);
		foreach($data_order as $row){
			$id_user = $row->id_penghuni;
			$id_kmr = $row->id_kmr;
		}
		...
		if($result['status_code'] == 200){
			$this->db->update('penyewaan', $data, array('order_id' => $order_id));
		    ...
		    $this->db->update('kamar', $data_kmr, array('id_kmr' => $id_kmr));
		}
